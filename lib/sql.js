...
SQLConnector.prototype.find = function(model, id, options, cb) {
  if (id == null) {
    process.nextTick(function() {
      var err = new Error(g.t('id value is required'));
      if (cb) {
        cb(err);
      }
    });
...
SQLConnector.prototype.toColumnValue = function(propertyDef, value) {
  throw new Error(g.t('{{toColumnValue()}} must be implemented by the connector'));
};
...
SQLConnector.prototype.fromColumnValue = function(propertyDef, value) {
  throw new Error(g.t('{{fromColumnValue()}} must be implemented by the connector'));
};
...
SQLConnector.prototype.escapeName = function(name) {
  throw new Error(g.t('{{escapeName()}} must be implemented by the connector'));
};
...
SQLConnector.prototype.escapeValue = function(value) {
  throw new Error(g.t('{{escapeValue()}} must be implemented by the connector'));
};
...
SQLConnector.prototype.getPlaceholderForIdentifier = function(key) {
  throw new Error(g.t('{{getPlaceholderForIdentifier()}} must be implemented by ' +
    'the connector'));
};
...
SQLConnector.prototype.getPlaceholderForValue = function(key) {
  throw new Error(g.t('{{getPlaceholderForValue()}} must be implemented by ' +
    'the connector'));
};
...
SQLConnector.prototype.applyPagination = function(model, stmt, filter) {
  throw new Error(g.t('{{applyPagination()}} must be implemented by the connector'));
};
...
SQLConnector.prototype.getCountForAffectedRows = function(model, info) {
  throw new Error(g.t('{{getCountForAffectedRows()}} must be implemented by ' +
    'the connector'));
};
...
SQLConnector.prototype.getInsertedId = function(model, info) {
  throw new Error(g.t('{{getInsertedId()}} must be implemented by the connector'));
};
...
SQLConnector.prototype.executeSQL = function(sql, params, options, callback) {
  throw new Error(g.t('{{executeSQL()}} must be implemented by the connector'));
};
